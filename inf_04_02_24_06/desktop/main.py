...
class MainWindow(QMainWindow):
    ...
    def set_texts(self):
        ...
        self.tracks_year_label.setText(f"{self.songs[self.curr_song].number_of_tracks} utworów         {self.songs[self.curr_song].year}")
...
""")
        ...
        self.tracks_year_label = QLabel(f"{self.songs[self.curr_song].number_of_tracks} utworów         {self.songs[self.curr_song].year}", self)
